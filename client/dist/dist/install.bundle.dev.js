...
(function () {
  var t = {
    61: function _(t, e, r) {
      ...
      function o() {
        ...
        function O(t, e) {
          var r = e.method,
              n = t.iterator[r];
          if (void 0 === n) return e.delegate = null, "throw" === r && t.iterator["return"] && (e.method = "return", e.arg = void 0, O(t, e), "throw" === e.method) || "return" !== r && (e.method = "throw", e.arg = new TypeError("The iterator does not provide a '" + r + "' method")), d;
        ...
        return y.prototype = g, a(b, "constructor", {
          value: g,
          configurable: !0
        }), a(g, "constructor", {
          value: y,
          ...
          return Object.setPrototypeOf ? Object.setPrototypeOf(t, g) : (t.__proto__ = g, f(t, l, "GeneratorFunction")), t.prototype = Object.create(b), t;
        }, e.awrap = function (t) {
          return {
            __await: t
          };
        }, L(E.prototype), f(E.prototype, s, function () {
          return this;
        ...
        }, L(b), f(b, l, "Generator"), f(b, c, function () {
          return this;
          ...
          reset: function reset(t) {
            if (this.prev = 0, this.next = 0, this.sent = this._sent = void 0, this.done = !1, this.delegate = null, this.method = "next", this.arg = void 0, this.tryEntries.forEach(P), !t) for (var e in this) {
    ...
    698: function _(t) {
      function e(r) {
        return t.exports = e = "function" == typeof Symbol && "symbol" == _typeof(Symbol.iterator) ? function (t) {
          return _typeof(t);
        } : function (t) {
      ...
      return o().wrap(function (t) {
        for (;;) {
          switch (t.prev = t.next) {
            ...
            case 3:
              e.prompt(), window.deferredPrompt = null, i.classList.toggle("hidden", !0);
